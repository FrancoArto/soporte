 ...
 <br>
  ...
  <div class="row">
                       ...
                       <div class="col-md-4">
                        ...
                        <div class="input-group">
                            <span class="input-group-addon alert-info" id="sizing-addon2"><i class="glyphicon glyphicon-chevron-right" ></i></span> <input id="txtAsignado" name="txtAsignado" type="text" placeholder="Asignado a..." class="form-control input-md txt" aria-describedby="sizing-addon2">
                        </div>
                        </div>
